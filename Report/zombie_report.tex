...
Using our R function to simulate from the model, the algorithm required a total of 3768 simulations and took 2.19 seconds to run. The final maximum epsilon value of the accepted simulations was 0.484.
